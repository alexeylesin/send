...
sendYourFilesLink = Попробовать LesinSend
...
notSupportedOutdatedDetail = К сожалению, эта версия Firefox не поддерживает веб-технологию, благодаря которой работает LesinSend. Ваш нужно обновить свой браузер.
...
javascriptRequired = Для LesinSend необходим JavaScript
whyJavascript = Почему LesinSend требуется JavaScript?
